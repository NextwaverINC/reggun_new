<%@ Page Title="" Language="C#" MasterPageFile="~/master/main.master" AutoEventWireup="true" CodeFile="reportLog.aspx.cs" Inherits="master_Default" %>
            ...
            <div class="col-lg-12">
                <div class="widget-box widget-color-blue">
                    <div class="widget-header">
                        <h5 class="widget-title">รายงาน Log</h5>
                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr style="width: 100%">
                                        ...
                                        <th class="text-center">ผลลัพธ์&nbsp;</th>
                                         <th class="text-center">พารามิเตอร์&nbsp;</th>
                                         <th class="text-center">วันที่สร้าง&nbsp;</th>
                                    </tr>
                                </thead>
                                <tbody>   
                                    <tr ng-repeat="item in DataReportLog" style="width: 100%">
                                        <td nowrap>{{item.UserName}}</td>
                                        <td nowrap>{{item.Menu}}</td>
                                        <td nowrap>{{item.Process}}</td>
                                        <td nowrap>{{item.Result}}</td>
                                         <td nowrap>{{item.Param}}</td>
            ...
            $scope.fnLoadCountData = function () {
                ...
                $http.post("../server/Server_Gunbook.aspx", data, config)
                    .success(function (data, status, headers, config) {
                        ...
                        $scope.DataReportLog = data.DATAREPORTBOOK;
