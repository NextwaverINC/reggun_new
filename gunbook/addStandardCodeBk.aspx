<%@ Page Language="VB" AutoEventWireup="false" CodeFile="addStandardCodeBk.aspx.vb" Inherits="gunbook_addStandardCode" %>
                ...
                <div class="widget-body">
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <label>ข้อมูล</label></td>
                            <td style="width: 5px"></td>
                            <td>
                                <input type="text" id="dataStandard" placeholder="ข้อมูล" style="width: 100%" /></td>
                            <td style="width: 20px"></td>
                            <td style="width: 20px"></td>
                            <td>
                                <label>รายละเอียด</label></td>
                            <td style="width: 5px"></td>
                            <td>
                                <input type="text" id="dataStandard" placeholder="ข้อมูล" style="width: 100%" /></td>
                            <td style="width: 20px"></td>
    ...
    <script>
        ...
        function StartApp($scope, $http) {
            ...
            $scope.fnSave = function () {
                var datastr = document.getElementById('dataStandard').value;
            ...
            $scope.loadData = function() {
                ...
                $http.post("../server/Server_Gunbook.aspx", data, config)
                    .success(function (data, status, headers, config) {
                        if (data.output == "OK") {
                            document.getElementById('dataStandard').value = data.STRDATA;
                            fnUnLoading();
                        } else {
