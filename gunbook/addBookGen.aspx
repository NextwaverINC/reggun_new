<%@ Page Language="VB" AutoEventWireup="false" CodeFile="addBookGen.aspx.vb" Inherits="gunbook_addBook" %>
                ...
                <div class="widget-body">
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 5px"></td>
                            <td>
                                <input type="text" id="gunregidprefix" placeholder="คำนำหน้า" style="width: 100%" /></td>
                            <td style="width: 20px"></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="height: 5px"></td>
