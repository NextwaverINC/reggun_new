...
// Load sample image
/*
imageEditor.loadImageFromURL('http://nextwaverinc.ddns.net:81/reggun_img/'+window.opener.tmp_src_img, 'SampleImage').then(sizeValue => {
    console.log(sizeValue);
    imageEditor.clearUndoStack();
});*/
imageEditor.loadImageFromURL( window.opener.tmp_src_img, 'SampleImage').then(sizeValue => {
    console.log(sizeValue);
    imageEditor.clearUndoStack();
});
// IE9 Unselectable
