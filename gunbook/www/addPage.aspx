...
<body style="background-color: white">
                            ...
                            <div class="row" style="margin: 5px 15px 0px 0px">
                                <div class="col-sm-12 text-right" style="padding: 0px;">
                                    <a class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModalAddRecord" ng-click="clearId()">
                                        <i class="ace-icon fa fa-plus bigger-110"></i>สร้างเลขทะเบียนอาวุธปืน
                                    </a>
                                    <a class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModalAddNumber" ng-show="DataRecords.length > 0">
                                        <i class="ace-icon fa fa-plus bigger-110"></i>เพิ่มเลขหมายอาวุธปืนทั้งหมด
                                    </a>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">เพิ่มรหัสทะเบียนอาวุธปืน
                                        </h4>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class=" col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7 col-xs-12">
                                                        <input type="text" class="form-control" ng-model="prefixid" style="width: 100%" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class=" col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7 col-xs-12">
                                                        <input type="text" class="form-control" ng-model="lastid" style="width: 100%" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class=" col-sm-12" style="padding-bottom: 5px;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 col-xs-12">
                                                            <input type="text" class="form-control" ng-model="dataStandard.dataname" style="width: 100%" ng-keypress="checkIfEnterKeyWasPressed($event)" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class=" col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 col-xs-12">
                                                            <textarea ng-model="dataStandard.datadesc" class="form-control" rows="5" ng-keypress="checkIfEnterKeyWasPressed($event)"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-dialog modal-dialog-fullscreen" style="width: 400px;">
                            <div class="modal-content modal-content-fullscreen">
                                <div class="modal-header" style="padding: 10px 5px 5px 5px; background: #eff3f8;">
                                    ...
                                    <h4 class="modal-title">ข้อมูลเลขหมายอาวุธปืนทั้งหมด
                                    </h4>
                                </div>
    ...
    <script>
        ...
        function StartApp($scope, $http, $filter) {
            ...
            $scope.titleHead = "จัดการข้อมูลหนังสือทะเบียนอาวุธปืน";
            ...
            $scope.addMultiRow = function () {
                ...
                //    $scope.GunIDArray.push(prefixid + GunRegID.toString() + lastid);
          ...
          //  $scope.GunIDArray = []; 
            ...
            /*    $scope.GunRegID_gen = [];
                ...
                try {
                    ...
                    if (!$scope.startid || !$scope.endid) {
                        alert("โปรดระบุเลขทะเบียนอาวุธปืนเริ่มต้น และเลขทะเบียนอาวุธปืนสิ้นสุด");
                    } else {

                        var _startId = $scope.startid;
                        var _endId = $scope.endid;
                        let _stID = -1;
                        let _enID = -1;

                        for (var i = 0; i < $scope.GunIDArray.length; i++) {
                            if (_startId == $scope.GunIDArray[i]) _stID = i;
                            if (_endId == $scope.GunIDArray[i]) _enID = i;
                        }
                        if (_stID == -1 || _enID == -1) {
                            alert("โปรดระบุช่วงของเลขทะเบียนอาวุธปืนให้ถูกต้อง");
                        }
                        else {
                            if (_stID > _enID)[_stID, _enID] = [_enID, _stID];
                            for (var i = _stID; i <= _enID; i++) {
                                $scope.GunRegID_gen.push($scope.GunIDArray[i]);
                            }
                            ...
                            angular.forEach($scope.DataRecords, function (value, key) {
                                ...
                                if ($scope.GunRegID_gen.indexOf(value.GunRegID.toString()) > -1) {
