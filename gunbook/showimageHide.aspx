<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showimageHide.aspx.cs" Inherits="gunbook_showimage" %>
...
<body style="height: 100%">
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 120px;">
                                    <input type="number" class="form-control" ng-model="bookno" min="1" style="width: 100%; background-color: #f7f7f7;" disabled/>
                                </td>
                                <td style="width: 100px;" style="width: 100px;" class="text-right"><span class="text-right"><strong>หน้า :</strong>&nbsp;&nbsp;</span></td>
                                <td style="width: 120px;">
                                    <input type="number" class="form-control" ng-model="pageno" min="1" style="width: 100%; background-color: #f7f7f7;" disabled/>
                                </td>
                                <td style="width: 100px;" class="text-right"><span class="text-right"><strong>เวอร์ชั่น :</strong>&nbsp;&nbsp;</span></td>
                                <td style="width: 100px;">
                                    <input type="number" class="form-control" ng-model="pagever" min="1" style="width: 100%; background-color: #f7f7f7;" disabled/>
                                </td>
                             
                         <%--       <td style="width: 100px;" class="text-right">
                                    <button class="btn btn-info" style="float: right; border: 0px;" ng-click="fnOpenImage()" disabled>
                                        ดูรูปภาพ
                                    </button>
                                </td>--%>
                                ...
                                <td style="width:5px"></td>
                                 <td class="text-right">
                                    <a class="btn btn-info" style="float: right; border: 0px;" id="dowload_img" download="image.png" onclick="fnDownload()">ดาวน์โหลด
                                    </a>
                                </td>  
                  <%--              <td style="width:5px"></td>
                                <td class="text-right">                                   
                                    <a class="btn btn-info" style="float: right; border: 0px;" onclick="fnEditImg()" disabled>
                                        Edit
                                    </a>
                                </td> --%>  
                               <%-- <td style="width:5px"></td>
                                <td class="text-right">                                   
                                    <button class="btn btn-info" style="float: right; border: 0px;" ng-click="reportImg()" disabled>
    ...
    <script>
        function fnEditImg() {
            var win = window.open("edit_img/index.html");
        }
        function fnPrint() {
        ...
        function StartApp($scope, $http) {
            ...
            $scope.gunregId = parseInt(getParamValue("GunID"));
            ...
            $scope.fnOpenImage = function () {
                window.open('showimageHide.aspx?Book=' + $scope.bookno + '&Page=' + $scope.pageno + '&Ver=' + $scope.pagever + '&GID=' + $scope.gunregId, '_self');
            }
