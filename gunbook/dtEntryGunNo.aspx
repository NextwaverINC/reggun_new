<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dtEntryGunNo.aspx.cs" Inherits="gunbook_addPage" %>
...
<body style="background-color: white">
                    ...
                    <div class="widget-box transparent" id="widget-box-2">
                        <div class="widget-header widget-header-small">
                            ...
                            <%--    <a ng-show="StatusPage == 'Scan' || StatusPage == 'Save'" class="btn btn-info" ng-click="fnSave('1')" style="width: 100px;">
                                ...
                                <a ng-show="StatusPage != 'Create'" class="btn btn-primary" ng-click="fnSave()" style="width: 100px;">
    ...
    <script>
                    ...
                    .success(function (data, status, headers, config) {
                        if (data.output == 'OK') {
                         ...
                         /*   if (type != "1" && type != "0") {
                            ...
                            //window.parent.refreshAllData();
                            alert('บันทึกข้อมูลสำเร็จ กดปุ่ม Cancel เพื่อปิดหน้า');
                            return;
                        } else {
        ...
        function openImage() {
            window.open('showimageImport.aspx?Book=' + document.getElementById('bookno').innerHTML + '&Page=' + document.getElementById('pageno').innerHTML + '&Ver=' + document.getElementById('pagever').innerHTML, '_blank');
        }
