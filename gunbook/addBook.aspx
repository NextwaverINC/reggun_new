                ...
                <div class="widget-body">
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td style="width: 5px"></td>
                            <td>
                                <input type="text" id="bookyear" placeholder="ปี พ.ศ." style="width: 100%"  maxlength="4" size="4"/></td>
                            <td style="width: 20px"></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="height: 5px"></td>
                        ...
                        <tr>
                            ...
                            <td style="width: 5px"></td>
                            <td>
                                <input type="text" id="gunregidstart" placeholder="เลขทะเบียนเริ่มต้น" style="width: 100%" /></td>
                            <td style="width: 20px"></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="height: 5px"></td>
                        ...
                        <tr>
                            ...
                            <td style="width: 5px"></td>
                            <td>
                                <input type="text" id="gunregidend" placeholder="เลขทะเบียนสิ้นสุด" style="width: 100%" /></td>
                            <td style="width: 20px"></td>
                        </tr>
                        <tr>
                            <td colspan="5" style="height: 5px"></td>
                        ...
                        <tr>
                            ...
                            <td style="width: 5px"></td>
                            <td>
                                <input type="text" id="groupgun" placeholder="ประเภทอาวุธปืน" style="width: 100%"/></td>
                            <td style="width: 20px"></td>
                        </tr>                        
                        <tr>
                            <td colspan="5" style="height: 5px"></td>
                        ...
                        <tr>
                            ...
                            <td>
                                 <div class="input-group">
									  <input class="form-control date-picker" id="expire_date"  placeholder="วันที่หมดอายุ" type="text" data-date-format="dd/mm/yyyy" />
...
<%--    <link href="../assets/bootstrap-dialog/css/bootstrap-dialog.css" rel="stylesheet" />
    ...
    <script>
        ...
        function fnSave() {
            ...
            var groupgun = document.getElementById('groupgun').value;
            ...
            if (bookno == "") {
             ...
             //   ERROR.innerHTML = "โปรดระบุเลขที่หนังสือเป็นตัวเลขจำนวนเต็ม";
	...
	/*
            ...
            if (pagetotal == "") {
                ERROR.innerHTML = "โปรดระบุจำนวนหน้าเป็นตัวเลขจำนวนเต็ม อย่างน้อย 1 หน้า";
                return;
            }
